				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumbs">
							...
							<li class="trail-item">
								<a href="{{url('/brands')}}" title="">Brands</a>
								<span><img src="{{asset('images/icons/arrow-right.png')}}" alt=""></span>
							</li>
							<li class="trail-end">
								<a href="#" title="">
						...
						<div class="main-shop">
								...
								<div class="tab-product">
									<div class="row sort-box">
									  @foreach($products as $product)
										<div class="col-lg-4 col-sm-6 product c{{$product->category_id}} s{{$product->subcategory_id}} m{{$product->minicategory_id}} @foreach($product->colors as $color){{$color->color}} @endforeach @foreach($product->sizes as $size){{$size->size}} @endforeach" data-price="{{$product->price}}">
							...
							@else
								<div class="alert alert-danger">
									<h1 style="text-align:center">No products available for this brand!</h1>
								</div>
