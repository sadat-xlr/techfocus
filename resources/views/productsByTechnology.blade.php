                ...
                <div class="col-md-12">
                    ...
                    <div class="brands-list grid">
                        @foreach($technologies as $technology)
                            <div class="brands-item ipsotope {{strtolower(substr($technology->technologyName, 0, 1))}}">
                                <a href="{{URL::to('/productsByTech/'.$technology->id)}}" class="box-cat" title="">
                                    <div class="cat-name">
                                        {{$technology->technologyName}}
                                    </div>
                                    <div class="numb-product">
                                        <?php $i = 0; ?>
                                        @foreach($technology->product as $product)
                                            <?php $i++; ?>
                                        @endforeach
                                        {{$i}} Product
                                    </div>
