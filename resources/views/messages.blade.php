...
<div class="modal fade" id="compare" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title">Compare product</h1>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
        <a id="compareSimiliar" class="btn btn-warning float-left">Compare similiar</a>
        <a id="compareList" class="btn btn-warning float-right">Add to compare list</a>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
      </div>
...
<div class="modal fade" id="quotation" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title">Ask for price quotation</h3>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
        <section class="flat-contact" style="padding: 0">
          <div class="container">
            <div class="row">
              <div class="form-contact center" style="margin-top: 0">
                <div class="form-contact-content">
                  <form action="{{url('/addMessage')}}" method="post" id="form-contact" accept-charset="utf-8">
                    ...
                    <div class="form-box one-half password-contact">
                      <label for="password-contact">Country name</label>
                      <select id="country" name="country" class="form-control" style="border-radius:50px;">
                    ...
                    <input type="hidden" id="messageBody" name="comment">
