								...
								@foreach ($categories as $category)
									@foreach ($category->subcategory as $subcategory)
										@foreach ($subcategory->minicategory as $minicategory)
											@if ($minicategory->id == $miniCat)
												<li class="trail-item">
													<a href="{{url('productsByCat/'.$category->id)}}" title="">{{$category->categoryName}}</a>
													<span><img src="{{asset('images/icons/arrow-right.png')}}" alt=""></span>
												</li>
												<li class="trail-item">
													<a href="{{URL::to('/productsByCat/'.$category->id."/".$subcategory->id)}}" title="">{{$subcategory->categoryName}}</a>
													<span><img src="{{asset('images/icons/arrow-right.png')}}" alt=""></span>
												</li>
												<li class="trail-end">
													<a href="#" title="">{{$minicategory->miniCategoryName}}</a>
												</li>
											@endif
										@endforeach
									@endforeach
								...
								@foreach ($categories as $category)
									@foreach ($category->subcategory as $subcategory)
										@if ($subcategory->id == $subCat)
											...
											<li class="trail-end">
												<a href="#" title="">{{$subcategory->categoryName}}</a>
											</li>
										@endif
									@endforeach
								@endforeach
									...
									<ul class="box-checkbox scroll">
									  ...
									  <?php $j++; ?>
										<li class="check-box brands">
											<input type="checkbox" id="checkbox{{$j}}" name="checkbox{{$j}}" value=".b{{$brand->id}}">
						...
						<div class="main-shop">
													...
													<div class="box-bottom">
														@if ($product->price)
															<div class="btn-add-cart">
																<a href="{{URL::to('/addCart/'.$product->slug)}}" title="">
																	<img src="{{asset('images/icons/add-cart.png')}}" alt="">Add to Cart
																</a>
															</div>
														@endif
														<div class="compare-wishlist">
															<a href="#" class="compare" title="" data-comparelist="{{URL::to('/addCompare/'.$product->slug)}}" data-comparesimiliar="{{URL::to('/compareSimiliar/'.$product->slug.'/'.$product->minicategory_id)}}">
																<img src="{{asset('images/icons/compare.png')}}" alt="">Compare
															</a>
															<a href="{{URL::to('/addWishlist/'.$product->slug)}}" class="wishlist" title="">
							...
							@else
								<div class="alert alert-danger">
									<h1 style="text-align:center">No products available for this category!</h1>
								</div>
