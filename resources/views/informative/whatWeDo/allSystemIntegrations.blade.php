                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="city_blog_grid">
                            <div class="city_blog_grid_text">
                                ...
                                <h6><a href="#">{{$systemIntegration->topic}}</a></h6>
                                <p>{{$systemIntegration->title}}</p>
                                <a href="{{url('system-integration/'.$systemIntegration->id)}}">See More<i class="fa fa-angle-double-right"></i></a>
                            </div>
                        </div>
                    </div>
                @endforeach
