...
@section('content')
    ...
    <div class="sab_banner overlay">
        <div class="container">
            <div class="sab_banner_text">
                <h2>{{$digitalInnovation->title}}</h2>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
                    <li class="breadcrumb-item"><a href="#">{{$digitalInnovation->topic}}</a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-4">
                        {!!$digitalInnovation->description_1!!}
                </div>
                <div class="col-md-6 col-sm-4">
                        {!!$digitalInnovation->description_2!!}
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-4">
                        {!!$digitalInnovation->description_3!!}
                </div>
            </div>
        </div>
    </div>
    <!--CITY AWARD WRAP END-->
    <!--CITY AWARD WRAP START-->
    @if ($digitalInnovation->description_4)
        <div class="city_award_wrap" style="background-color: #F5F2F1">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-4">
                            {!! $digitalInnovation->description_4 !!}
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="city_event_detail">
                        ...
                        <div class="city_health2_text team">
                            ...
                            <div class="city-health2-slider2">
                                @foreach ($digitalInnovation->products as $product)
                                    <div>
                ...
                <div class="col-md-6">
                    <div class="city_event_detail">
                        ...
                        <div class="city_health2_text team">
                            ...
                            <!--SECTION HEADING END-->
                            <div class="city-health2-slider2">
                                @foreach ($digitalInnovation->solutions as $solution)
                                    <div>
