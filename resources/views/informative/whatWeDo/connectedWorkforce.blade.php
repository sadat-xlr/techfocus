...
@section('content')
    ...
    <div class="sab_banner overlay">
        <div class="container">
            <div class="sab_banner_text">
                <h2>{{$connectedWorkforce->title}}</h2>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
                    <li class="breadcrumb-item"><a href="{{url('/connected-workforce-all')}}">Connected Workforce</a></li>
                    <li class="breadcrumb-item"><a href="#">{{$connectedWorkforce->topic}}</a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    {!!$connectedWorkforce->description!!}
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-4">
                        {!!$connectedWorkforce->description_1!!}
                </div>
            </div>
        </div>
    </div>
    <!--CITY AWARD WRAP END-->
    <!--CITY AWARD WRAP START-->
    @if ($connectedWorkforce->description_2)
        <div class="city_award_wrap" style="background-color: #F5F2F1">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-4">
                        {!!$connectedWorkforce->description_2!!}
                    </div>
                </div>
            </div>
        </div>  
    ...
    <!--CITY AWARD WRAP END-->
    <!--CITY AWARD WRAP START-->
    @if ($connectedWorkforce->description_3)
        <div class="city_award_wrap" style="background-color: #FFFFFFFF">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-4">
                            {!!$connectedWorkforce->description_3!!}
                    </div>
                </div>
            </div>
        </div>  
    ...
    <!--CITY AWARD WRAP END-->
    <!--CITY AWARD WRAP START-->
    @if ($connectedWorkforce->description_4)
        <div class="city_award_wrap" style="background-color: #F5F2F1">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-4">
                            {!! $connectedWorkforce->description_4 !!}
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="city_event_detail">
                        ...
                        <div class="city_health2_text team">
                            ...
                            <div class="city-health2-slider2">
                                @foreach ($connectedWorkforce->products as $product)
                                    <div>
                ...
                <div class="col-md-6">
                    <div class="city_event_detail">
                        ...
                        <div class="city_health2_text team">
                            ...
                            <!--SECTION HEADING END-->
                            <div class="city-health2-slider2">
                                @foreach ($connectedWorkforce->solutions as $solution)
                                    <div>
