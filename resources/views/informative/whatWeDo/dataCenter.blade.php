...
@section('content')
    ...
    <div class="sab_banner overlay">
        <div class="container">
            <div class="sab_banner_text">
                <h2>{{$dataCenter->title}}</h2>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
                    <li class="breadcrumb-item"><a href="#">{{$dataCenter->topic}}</a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-4">
                        {!!$dataCenter->description_1!!}
                </div>
                <div class="col-md-6 col-sm-4">
                        {!!$dataCenter->description_2!!}
                </div>
            </div>
        </div>
    </div>
    ...
    <!--CITY AWARD WRAP END-->
    <!--CITY AWARD WRAP START-->
    @if ($dataCenter->description_4)
        <div class="city_award_wrap" style="background-color: #F5F2F1">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-4">
                            {!!$dataCenter->description_4!!}
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="city_event_detail">
                        ...
                        <div class="city_health2_text team">
                            ...
                            <div class="city-health2-slider2">
                                @foreach ($dataCenter->products as $product)
                                    <div>
                                        <a href="{{url('product-info/'.$product->id.'/'.$product->slug)}}">
                                            <div class="city_senior_team">
                                                ...
                                                <div class="city_senior_team_text">
                                                    <h6 style="font-size: 12px">{{$product->productName}}</h6>
                                                </div>
                                            </div>
                                        </a>
                                    </div>	 					
                ...
                <div class="col-md-6">
                    <div class="city_event_detail">
                        ...
                        <div class="city_health2_text team">
                            ...
                            <!--SECTION HEADING END-->
                            <div class="city-health2-slider2">
                                @foreach ($dataCenter->solutions as $solution)
                                    <div>
