        ...
        <div class="container">
            <div class="sab_banner_text">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Media Archive</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="event_sidebar">
                            ...
                            <div class="categories_list archive">
                                <ul>
                                    ...
                                    @foreach ($news_by_month as $month)
                                        <li><a href="{{url('media-archive?month='.$month->month)}}">{{$month->month_name}}<span style="float: right;margin-right:10px;">({{$month->news_count}})</span></a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
                                ...
                                <li>
                                    <div id="news-{{$singleNews->id}}" class="city_news2_detail" style="padding: 10px;">
                                        <ul class="city_meta_list">
                                            <li><a href="#"><i class="fa fa-calendar"></i>Posted: {{$singleNews->created_at}}</a></li>
                                        </ul>
