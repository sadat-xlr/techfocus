...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>TechFocus Admin Panel</title>
	<meta name="description" content="TechFocus Admin Panel.">
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="login-box">
					...
					<form class="form-horizontal" action="{{url('/loginAuth')}}" method="post">
						{{csrf_field()}}
						<fieldset>
							
							<div class="input-prepend" title="E-mail">
								<span class="add-on"><i class="halflings-icon user"></i></span>
								<input class="input-large span10" name="email" id="email" type="email" placeholder="type E-mail" required/>
							</div>
