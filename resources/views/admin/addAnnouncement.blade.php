...
@section('breadcrumb')
    <li>
        <a href="{{url('announcements')}}">Announcement</a>
    </li>
    <li>
        <i class="icon-edit"></i>
    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon edit"></i><span class="break"></span>Add Announcement</h2>
                <div class="box-icon">
            ...
            <div class="box-content">
                <form class="form-horizontal" action="{{url('announcements')}}" method="post" enctype="multipart/form-data" role="form">
                    {{csrf_field()}}
                    <fieldset>
