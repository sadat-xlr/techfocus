			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Add Technology</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" action="{{url('/insertTechnology')}}" method="post">
						{{csrf_field()}}
						  <fieldset>
							<div class="control-group">
							  <label class="control-label" for="text">Technology Name</label>
							  <div class="controls">
								<input type="text" class="input-xlarge" name="technologyName">
							  </div>
							</div>
