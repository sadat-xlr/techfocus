    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon user"></i><span class="break"></span>Top Request</h2>
                <div class="box-icon">
                ...
                <table id="example1" class="table table-striped table-bordered bootstrap-datatable datatable">
                    <thead>
                        <tr>
                            ...
                            <th>
                                action
                                @if (!count($topRequests)>0)
                                    <a href="{{url('top-requests/create')}}" class="btn btn-success btn-sm">
                    ...
                    @foreach($topRequests as $topRequest)
                        <tr id="top_request{{$topRequest->id}}">
                            <td>{{$topRequest->label1}}</td>
                            <td>{{$topRequest->label2}}</td>
                            <td>{{$topRequest->label3}}</td>
                            <td>{{$topRequest->label4}}</td>
                            <td>
                                <div class="table-data-feature">
                                    <a href="#" class="edit-topRequest btn btn-warning btn-sm" data-id="{{$topRequest->id}}" data-label1="{{$topRequest->label1}}" data-label2="{{$topRequest->label2}}" data-label3="{{$topRequest->label3}}" data-label4="{{$topRequest->label4}}" data-label5="{{$topRequest->label5}}" data-label6="{{$topRequest->label6}}" data-label_url1="{{$topRequest->label_url1}}" data-label_url2="{{$topRequest->label_url2}}" data-label_url3="{{$topRequest->label_url3}}" data-label_url4="{{$topRequest->label_url4}}" data-label_url5="{{$topRequest->label_url5}}" data-label_url6="{{$topRequest->label_url6}}" >
                                        <i class="halflings-icon white edit"></i>
                                    </a>
                                    <a href="#" class="delete-topRequest btn btn-danger btn-sm" data-id="{{$topRequest->id}}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            <div class="box-header" data-original-title>
                                <h2><i class="halflings-icon edit"></i><span class="break"></span>Edit TopRequest</h2>
                                <div class="box-icon">
                                    <a href="#" class="btn-setting"><i class="halflings-icon wrench"></i></a>
                                    <a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
                                    <a href="#" class="btn-close"><i class="halflings-icon remove"></i></a>
                            ...
                            <div class="box-content">
                                <form class="form-horizontal" action="{{url('top-requests')}}" role="modal" id="toprequest_update-form">
                                    <fieldset>
