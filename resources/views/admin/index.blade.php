...
@section('adminContent')
			...
			<div class="row-fluid">
				...
				<div class="span3 statbox green" onTablet="span6" onDesktop="span3">
					...
					<div class="number" style="font-size: medium">{{number_format($sum)}}<i class="icon-arrow-up"></i></div>
					<div class="title">sales</div>
					<div class="footer">
						<a href="{{url('orders')}}"> read full report</a>
					</div>
				</div>
				...
				<div class="span3 statbox yellow" onTablet="span6" onDesktop="span3">
					...
					<div class="number" style="font-size: medium">{{number_format($target)}}/{{number_format($quoteValue)}}<i class="icon-arrow-down"></i></div>
					<div class="title">target vs achievement</div>
					<div class="footer">
						<a href="#"> read full report</a>
					</div>
				</div>	
				...
				<div class="widget span3 red" onTablet="span6" onDesktop="span3">
					...
					<div class="content">
						...
						<div class="browserStat big">
							<img src="admin/img/browser-chrome-big.png" alt="Chrome">
							<span>34%</span>
						</div>
						<div class="browserStat big">
							<img src="admin/img/browser-firefox-big.png" alt="Firefox">
							<span>34%</span>
						</div>
						<div class="browserStat">
							<img src="admin/img/browser-ie.png" alt="Internet Explorer">
							<span>34%</span>
						</div>
						<div class="browserStat">
							<img src="admin/img/browser-safari.png" alt="Safari">
							<span>34%</span>
						</div>
						<div class="browserStat">
							<img src="admin/img/browser-opera.png" alt="Opera">
							<span>34%</span>
						</div>	
				...
				<div class="box black span4" onTablet="span6" onDesktop="span4">
					...
					<div class="box-content">
						<ul class="dashboard-list metro">
							<li class="green">
								<a href="#">
									<img class="avatar" alt="Lucas" src="admin/img/avatar.jpg">
								</a>
							...
							<li class="yellow">
								<a href="#">
									<img class="avatar" alt="Bill" src="admin/img/avatar9.jpg">
								</a>
							...
							<li class="red">
								<a href="#">
									<img class="avatar" alt="Jane" src="admin/img/avatar5.jpg">
								</a>
							...
							<li class="blue">
								<a href="#">
									<img class="avatar" alt="Kate" src="admin/img/avatar6.jpg">
								</a>
