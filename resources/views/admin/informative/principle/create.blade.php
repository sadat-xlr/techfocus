...
@section('breadcrumb')
    <li>
        <a href="{{url('principles')}}">Principles</a>
    </li>
    <li>
        <i class="icon-edit"></i>
        <a href="#">Create Principle</a>
    </li>
@endsection
    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <div class="box-content">
                <form class="form-horizontal" action="{{url('principles')}}" method="POST" enctype="multipart/form-data" role="form">
                    {{ csrf_field() }}
                    <fieldset>
