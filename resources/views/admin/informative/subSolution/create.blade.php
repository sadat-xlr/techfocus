    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <div class="box-content">
                <form class="form-horizontal" enctype="multipart/form-data" action="{{url('/store-subsolution')}}" method="post">
                {{csrf_field()}}
                    <fieldset>
                    <div class="control-group">
                        <label class="control-label" for="text">Sub-Solution Name</label>
                        <div class="controls">
                        <input type="text" class="input-xlarge" name="subSolutionName">
                        </div>
                    </div>
                    <div class="control-group">
