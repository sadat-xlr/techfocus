...
@section('breadcrumb')
    <li>
        <a href="{{url('/digital-innovations')}}">Digital Innovation</a>
    </li>
    <li>
        <i class="icon-edit"></i>
    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <div class="box-content">
                <form class="form-horizontal" action="{{url('update-digital-innovations/'.$digitalInnovation->id)}}" method="post" enctype="multipart/form-data" role="form" id="banner_add-form">
                    {{csrf_field()}}
                    <fieldset>
                        <div class="control-group">
                            <label class="control-label" for="topic">Topic</label>
                            <div class="controls">
                                <input type="text" class="form-control" name="topic" maxlength="35" required placeholder="topic should be in 35 characters " value="{{$digitalInnovation->topic}}">
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="title">Title</label>
                            <div class="controls">
                                <input type="text" name="title" required value="{{$digitalInnovation->title}}">
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="description">Description</label>
                            <div class="controls">
                                <textarea class="controls" name="description" id="description" cols="30" rows="20" required>{!! $digitalInnovation->description !!}</textarea>
                            </div>
                            {{-- <script>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea class="controls" name="description_1" id="description_1" cols="30" rows="20" required>{!! $digitalInnovation->description_1 !!}</textarea>
                            </div>
                            {{-- <script>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea class="controls" name="description_2" id="description_2" cols="30" rows="20" required>{!! $digitalInnovation->description_2 !!}</textarea>
                            </div>
                            {{-- <script>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea class="controls" name="description_3" id="description_3" cols="30" rows="20" required>{!! $digitalInnovation->description_3 !!}</textarea>
                            </div>
                            {{-- <script>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea class="controls" name="description_4" id="description_4" cols="30" rows="20">{!! $digitalInnovation->description_4 !!}</textarea>
                            </div>
                            {{-- <script>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <ul>
                                    @foreach ($digitalInnovation->products as $relatedProduct)
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <ul>
                                    @foreach ($digitalInnovation->solutions as $relatedSolution)
