    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon user"></i><span class="break"></span>All Digital Innovation Related Content</h2>
                <div class="box-icon">
                ...
                <table id="example2" class="table table-striped table-bordered bootstrap-datatable datatable">
                    <thead>
                        <tr>
                            ...
                            <th>
                                action
                                <a href="{{url('create-digital-innovations')}}" class="btn btn-success btn-sm">
                    ...
                    <tbody>
                        @foreach($digitalInnovations as $digitalInnovation)
                            <tr>
                                <td>{{$digitalInnovation->topic}}</td>
                                <td>{{$digitalInnovation->title}}</td>
                                <td>
                                    <div class="table-data-feature">
                                        <a href="{{url('edit-digital-innovations/'.$digitalInnovation->id)}}" class="btn btn-warning btn-sm">
                                            <i class="halflings-icon white edit"></i>
                                        </a>
                                        {{-- <a href="#" class="delete-digitalInnovation btn btn-danger btn-sm" data-id="{{$digitalInnovation->id}}">
                                            <i class="halflings-icon white trash"></i>
                                        </a> --}}
                                        <form action="{{ url('/delete-digital-innovations', ['id' => $digitalInnovation->id]) }}" method="post">
