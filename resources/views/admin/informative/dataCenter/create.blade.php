    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <div class="box-content">
                <form class="form-horizontal" action="{{url('store-cloud-datacenter')}}" method="post" enctype="multipart/form-data" role="form" id="banner_add-form">
                    {{csrf_field()}}
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea class="controls" name="description" id="description" cols="30" rows="20"></textarea>
                            </div>
                            {{-- <script>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea class="controls" name="description_2" id="description_2" cols="30" rows="20" required></textarea>
                            </div>
                            {{-- <script>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea class="controls" name="description_3" id="description_3" cols="30" rows="20" required></textarea>
                            </div>
                            {{-- <script>
