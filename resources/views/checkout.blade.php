				...
				<div class="row">
					<div class="col-md-7">
						<div class="box-checkout">
							...
							<form action="{{url('/order')}}" method="post" class="checkout" accept-charset="utf-8">
							{{csrf_field()}}
								<div class="billing-fields">
									...
									<div class="fields-content">
										...
										<div class="field-row">
											...
											<input type="text" id="address-2" name="address-2" placeholder="Apartment, suite, unit etc. (optional)">
										</div>
										<div class="field-row">
										...
										<div class="field-row">
											<p class="field-one-half">
												<label for="state-country">State / Division *</label>
											...
											<p class="field-one-half">
												...
												<input type="text" id="post-code" name="postcode" placeholder="Postcode / ZIP">
											</p>
											<div class="clearfix"></div>
										</div>										
									</div><!-- /.fields-content -->
								...
								<div class="shipping-address-fields">
									...
									<div class="fields-content" id="shipping">
										<div class="field-row">
											<label>Country *</label>
								...
								<div id="payment" class="woocommerce-checkout-payment">
									<ul class="wc_payment_methods payment_methods methods">
										...
										<li class="wc_payment_method payment_method_cod">
											...
											<input id="payment_method_cod" type="radio" class="input-radio" name="paymentMethod" value="4" data-order_button_text="" disable>
