				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumbs">
							...
							<li class="trail-item">
								<a href="{{url('/technologies')}}" title="">Technologies</a>
								<span><img src="{{asset('images/icons/arrow-right.png')}}" alt=""></span>
							</li>
							<li class="trail-end">
								<a href="#" title="">
						...
						<div class="sidebar ">
							<div class="widget widget-categories">
								<div class="widget-title">
									<h3>Technologies<span></span></h3>
								</div>
								<ul class="cat-list style1 widget-content">
									@foreach($technologies as $technologies)
									<li>
										<span>
											<a href="{{URL::to('/productsByTech/'.$technologies->id)}}" title="">{{$technologies->technologyName}}</a>
											<i>
												<?php $i = 0; ?>
												(@foreach($technologies->product as $product)
													<?php $i++; ?>
												@endforeach
												{{$i}})
											</i>
					...
					<div class="col-lg-9 col-md-8">
						<div class="main-shop">
							...
							<div class="wrap-imagebox">
								...
								{!!html_entity_decode($technology->description)!!}
								</div>
								@if (!$products->isEmpty())
								<div class="flat-row-title">
									<h3>
												...
												<div class="imagebox">
													...
													<div class="box-bottom">
														...
														<div class="compare-wishlist">
															<a href="#" class="compare" title="" data-comparelist="{{URL::to('/addCompare/'.$product->slug)}}" data-comparesimiliar="{{URL::to('/compareSimiliar/'.$product->id.'/'.$product->minicategory_id)}}">
							...
							@else
								<div class="alert alert-danger">
									<h1 style="text-align:center">No products available for this technology!</h1>
								</div>
